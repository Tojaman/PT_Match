...
public class GymImage extends BaseEntity {
    ...
    private GymImage(TrainerProfile trainerProfile, String imageUrl, int displayOrder) {
        this.trainerProfile = trainerProfile;
        this.imageUrl = imageUrl;
        this.displayOrder = displayOrder;
    }

    public static GymImage create(TrainerProfile trainerProfile, String imageUrl, int displayOrder) {
        return new GymImage(trainerProfile, imageUrl, displayOrder);
    }
