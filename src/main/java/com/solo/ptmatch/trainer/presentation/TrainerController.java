...
public class TrainerController {
    ...
    @GetMapping
    public ApiResponse<List<TrainerSummaryResponse>> getTrainers(TrainerSearchRequest request) {
        List<TrainerSummaryResponse> response = trainerProfileService.getTrainerSummaries(request.toQuery()).stream()
    ...
    public ApiResponse<TrainerDetailResponse> getTrainer(@PathVariable Long trainerId) {
        TrainerDetailResponse response = TrainerDetailResponse.from(trainerProfileService.getTrainerDetail(trainerId));
        return ApiResponse.success(response);
    }
    ...
    @PostMapping("/me")
    public ApiResponse<TrainerProfileUpsertResponse> register(@Valid @RequestBody TrainerProfileRegisterRequest request) {
        TrainerProfileUpsertResponse response = TrainerProfileUpsertResponse.from(trainerProfileService.registerTrainerProfile(request.toCommand()));
        return ApiResponse.success(response);
    }
    ...
    @PutMapping("/me")
    public ApiResponse<TrainerProfileUpsertResponse> update(@Valid @RequestBody TrainerProfileUpdateRequest request) {
        TrainerProfileUpsertResponse response = TrainerProfileUpsertResponse.from(trainerProfileService.updateTrainerProfile(request.toCommand()));
        return ApiResponse.success(response);
    }
}
