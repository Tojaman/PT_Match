...
public class FollowController {
    ...
    public ApiResponse<TrainerFollowToggleResponse> toggleFollow(@PathVariable Long trainerId) {
        TrainerFollowToggleResponse response = trainerFollowService.toggleFollow(trainerId);
    ...
    public ApiResponse<List<FollowedTrainerSummaryResponse>> getFollowedTrainers() {
        List<FollowedTrainerSummaryResponse> response = trainerFollowService.getFollowedTrainers();
        return ApiResponse.success(response);
    }
}
